...
regd_users.put("/auth/review/:isbn", (req, res) => {
  ...
  return res.status(200).json({message: "Review added/modified successfuly", reviews: books[isbn]});
});
...
regd_users.delete("/auth/review/:isbn", (req, res) => {
    ...
    return res.status(200).json({message: 'User review deleted', reviews: books[isbn]});
});
